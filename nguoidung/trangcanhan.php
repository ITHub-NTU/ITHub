...
<style>
  .custom-bg {
    background-image: url('../image/lienhe.png'); /* Thay 'link_to_your_image.jpg' bằng đường dẫn đến hình ảnh bạn muốn sử dụng */
    background-size: cover; /* Đảm bảo hình ảnh sẽ cover toàn bộ phần tử */
    height: 200px;
  }
</style>
