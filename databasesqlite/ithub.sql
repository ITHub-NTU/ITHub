...
('BV00000004', 'CD00000002', 'kabee', 'Anh yêu nhiều em', '<p>sdasd</p>', 'daduyet', '2023-11-07 15:19:07', '2023-11-07 15:27:26', '0000-00-00 00:00:00', 1),
('BV00000005', 'CD00000002', 'kabee', 'sdasdad', '<p>sdasdasd</p>', 'chuaduyet', '2023-11-07 15:20:33', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0),
('BV00000006', 'CD00000002', 'kabee', 's', '<p>sdsad</p>', 'chuaduyet', '2023-11-07 21:45:02', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0),
...
('hienhuynh', 'hien.ht.62cntt@ntu.edu.vn', '$2y$10$gNRx4lOFIVxxbcGPoi/S9eHjIKDQrzT7gTZKjGDpJuyEzpNy45ZOa', 'quantrivien', 'Huỳnh', 'Thanh Hiền', '2002-09-25', 'thanhhien.jpg', 'daxacminh', 'hoatdong'),
('kabee', 'kiet.nt.62cntt@ntu.edu.vn', '$2y$10$gNRx4lOFIVxxbcGPoi/S9eHjIKDQrzT7gTZKjGDpJuyEzpNy45ZOa', 'nguoidung', 'Nguyễn', 'Tuấn Kiệt', '2002-09-08', 'kabee.jpg', 'daxacminh', 'hoatdong'),
...
('quantrivien', 'ithub.@ntu.edu.vn', '$2y$10$gNRx4lOFIVxxbcGPoi/S9eHjIKDQrzT7gTZKjGDpJuyEzpNy45ZOa', 'quantrivien', 'Quản', 'Trị Viên', '2002-09-08', 'quantri.jpg', 'daxacminh', 'hoatdong'),
...
(2, 'kabee', 'chude2.png', '<i class=\"fas fa-book-open notification-reaction\" style=\"width: 30px; height: 30px; display: flex; align-items: center; justify-content: center; border-radius: 30px; color: white; background-image: linear-gradient(45deg, #0070E1, #14ABFE); font-size: 14px; position: absolute; bottom: 16px; left: 46px !important;\"></i>', 'quantri/baivietkiemduyet.php', 'Bạn có <strong>3</strong> bài viết mới cần duyệt trong chủ đề <strong>Android</strong>', '2023-11-07 21:57:34', 1, 1);
...
--
ALTER TABLE `tblthongbao`
  MODIFY `maTB` int(128) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
