CREATE TABLE `TblNguoiDung` (
  ...
  `quyen` ENUM('quantrivien', 'nguoidung', 'nguoidungbichan') NOT NULL,
  `hoND` varchar(100) NOT NULL,
  `tenND` varchar(255) NOT NULL,
  `ngaySinh` date NOT NULL,
  `anhDaiDien` varchar(255) NOT NULL,
  `xacThuc`ENUM('daxacminh', 'chuaxacminh') NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

INSERT INTO `tblnguoidung` (`taiKhoan`, `email`, `matKhau`, `quyen`, `hoND`, `tenND`, `ngaySinh`, `anhDaiDien`, `xacThuc`) VALUES
('kabee', 'kiet.nt.62cntt@ntu.edu.vn', 'Kabee@0809', 'nguoidung', 'Nguyễn', 'Tuấn Kiệt', '2002-09-08', 'kabee.jpg', 'daxacminh'),
('hienhuynh', 'hien.ht.62cntt@ntu.edu.vn', 'Thanhhien@0709', 'quantrivien', 'Huỳnh', 'Thanh Hiền', '2002-09-25', 'thanhhien.jpg', 'daxacminh'),
('phuongha', 'ha.ptp.62cntt@ntu.edu.vn', 'Phuongha@2101', 'quantrivien', 'Phan', 'Thị Phương Hà', '2002-01-21', 'phuongha.jpg', 'daxacminh'),
('ducnhong', 'nhong.nnd.62cntt@ntu.edu.vn', 'Ducnhong@2101', 'quantrivien', 'Nguyễn', 'Ngọc Đức Nhông', '2002-01-21', 'nuno.jpg', 'daxacminh'),
('thienlan', 'lan.pnt.62cntt@ntu.edu.vn', 'Thienlan@2312', 'nguoidungbichan', 'Phạm', 'Nguyễn Thiên Lân', '2002-12-23', 'thienlan.jpg', 'daxacminh');
...
INSERT INTO `TblChuDeBV` (`maCD`, `tenCD`, `anhCD`, `trangThaiCD`) VALUES ('CD00000001', 'Lập trình', 'chude1.png', 'hoatdong'), 
