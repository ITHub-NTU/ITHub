                        ...
                        <div class="col-xl-2 me-2" >
                            <div class="card" style="width: 200px;">
                                <div class="card-body">
                                    ...
                                    <div class="card-text" style="height:100px ;-webkit-line-clamp: 4; display: -webkit-box; -webkit-box-orient: vertical; overflow: hidden; text-overflow: ellipsis;  white-space: normal; word-wrap: break-word"><?php echo  $baiVietMoiNhat['noiDungBV']?></div>
